...
- [Blob](./cluster/blob/cluster.yaml): Create a GreptimeDB cluster with Azure Blob storage.
...
- [Blob](./standalone/blob/standalone.yaml): Create a GreptimeDB standalone with Azure Blob storage.
