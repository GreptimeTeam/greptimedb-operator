...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.EnableProfile, "enable-profile", o.EnableProfile, "Enable pprof performance profiling (exposes /debug/pprof endpoints).")
	fs.Int32Var(&o.ProfilePort, "profile-port", o.ProfilePort, "The port that pprof profiling HTTP server binds to (e.g., for accessing /debug/pprof).")
}
