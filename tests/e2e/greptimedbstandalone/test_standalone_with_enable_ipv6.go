...
// TestStandaloneWithEnableIPv6 tests a standalone with enable ipv6.
func TestStandaloneWithEnableIPv6(ctx context.Context, h *helper.Helper) {
	const (
		testCRFile  = "./testdata/resources/standalone/enable-ipv6/standalone.yaml"
