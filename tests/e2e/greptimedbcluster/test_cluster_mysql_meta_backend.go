...
// TestMySQLMetaBackend tests a cluster with mysql as the meta backend.
func TestMySQLMetaBackend(ctx context.Context, h *helper.Helper) {
	const (
		testCRFile  = "./testdata/resources/cluster/mysql-meta-backend/cluster.yaml"
