...
// TestClusterEnableFlow tests a cluster that enables flow.
func TestClusterEnableFlow(ctx context.Context, h *helper.Helper) {
	const (
		testCRFile  = "./testdata/resources/cluster/enable-flow/cluster.yaml"
		testSQLFile = "./testdata/sql/cluster/flow_basic.sql"
	)
